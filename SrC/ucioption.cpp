...
void init(OptionsMap& o) {
  ...
  o["Risk"]                  << Option(0, -100, 100);
  o["Fast_Play"]             << Option(false);
  o["Study"]                 << Option(false);
  o["Threads"]               << Option(1, 1, 128, on_threads);
  o["Hash"]                  << Option(16, 1, MaxHashMB, on_hash_size);
  o["Turbo Speed"]           << Option(false, on_large_pages);
  o["Clear Hash"]            << Option(on_clear_hash);
  o["Ponder"]                << Option(false);
  o["LMR"]                   << Option(20000, 0, 40000, on_search);
  o["CMH"]                   << Option(128, 0, 512, on_search);
  o["reductionThreshold"]    << Option(6, 2, 12, on_search);
  o["reductionFactor"]       << Option(17, 0, 34, on_search); 
